                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col space-y-6 text-left animate-fade-in" style={{ animationDelay: '0.4s' }}>
                        ...
                        <p className="text-gray-300 font-light leading-relaxed text-sm sm:text-base">
                            I am a passionate Full-Stack MERN Developer with hands-on experience building responsive and user-friendly web applications. I enjoy creating clean frontend interfaces and developing secure backend solutions while continuously improving my skills and learning modern web technologies.
                        </p>

                        <p className="text-gray-300 font-light leading-relaxed text-sm sm:text-base">
                            On the client side, I build responsive and interactive user interfaces using React and Tailwind CSS with a focus on clean design and usability. On the server side, I develop RESTful APIs and backend functionality using Express.js and Node.js, while managing application data with MongoDB.
                        </p>
